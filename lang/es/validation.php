...
return [
  ...
  /*
    ...
    | como las reglas de tamaño. Siéntete libre de ajustar cada mensaje aquí.
    |
    */
  ...
  /*
    ...
    | Esto permite especificar rápidamente un mensaje personalizado para una
    | regla y atributo específicos.
    |
    */
  ...
  /*
    ...
    | con algo más amigable como "Correo Electrónico" en lugar de "email".
    | Esto simplemente ayuda a que nuestros mensajes sean más expresivos.
    |
    */
